...
interface PostListRepository {
    fun getRecentPosts(tagId:Int? = null,locationState: LocationState): Flow<PagingData<Post>>
    //fun getPopularPosts(): Flow<PagingData<Post>>
    fun getPopularPosts(tagId:Int? = null, locationState: LocationState): Flow<PagingData<Post>>
