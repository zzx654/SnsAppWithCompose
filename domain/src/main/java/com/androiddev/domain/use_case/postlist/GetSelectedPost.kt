...
class GetSelectedPost @Inject constructor(
    ...
    suspend operator fun invoke(postid:Int,latitude:Double? = null,longitude:Double? = null): Flow<Resource<Posts>> = repository.getSelectedPost(postid,latitude,longitude)
}