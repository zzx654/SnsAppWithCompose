...
class EmailSignUp @Inject constructor(
    ...
    suspend operator fun invoke(account:String,password:String,phonenumber:String,authCode:String): Flow<Resource<AuthCodeResult>> = repository.emailSignUp(account, password, phonenumber, authCode)
}