...
class PostReply @Inject constructor(
    ...
    suspend operator fun invoke(postId:Int,ref: Int,text:String,anonymousNick:String? = null): Flow<Resource<GetCommentsResponse>> = repository.postReply(postId,ref,text,anonymousNick)
}