...
class GetNewPosts @Inject constructor(
    ...
    suspend operator fun invoke(postid:Int? = null,postdate:String? = null,latitude:Double,longitude:Double): Flow<Resource<Posts>> = repository.getNewPosts(postid,postdate,latitude,longitude)
}