...
fun NearPostsScreen(
    ...
    Box(
        modifier = Modifier.fillMaxSize().background(Color.LightGray.copy(alpha = 0.6f)),
        //.pullRefresh(pullRefreshState).verticalScroll(rememberScrollState()),
        ...
        LazyColumn(
            ...
            item{
                RadioChipButtons(
                    ...
                    onSelect = { viewModel.onEvent(GetNearPostsEvent.SetDistance(it))}
                )
