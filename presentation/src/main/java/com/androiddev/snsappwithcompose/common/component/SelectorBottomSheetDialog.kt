...
@Composable
fun <T : BottomSheetOption> SelectorBottomSheetDialog(
    state: BottomSheetDialogState<T>
) {
    if (state.showDialog) {
        val modalBottomSheetState = rememberModalBottomSheetState()
        val scope = rememberCoroutineScope()
        ModalBottomSheet(
            onDismissRequest = state.onClickCancel,
                ...
                state.options.forEach { item->
                    ...
                    Row(verticalAlignment = Alignment.CenterVertically,
                        ...
                        modifier = Modifier
                            ...
                            }.invokeOnCompletion { state.onOptionSelected(item) } }){
                        Image(
