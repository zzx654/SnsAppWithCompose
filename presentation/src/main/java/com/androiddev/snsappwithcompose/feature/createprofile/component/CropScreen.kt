        ...
        Text(
            ...
            modifier = Modifier
                ...
                .clickable{
                    ...
                    navController.previousBackStackEntry?.savedStateHandle?.set(getString(context,R.string.encodedBitmap),
                        encodeToBase64(croppedBitmap, Bitmap.CompressFormat.JPEG, 100)
                    )
