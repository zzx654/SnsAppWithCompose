...
fun NearbypostsScreen(
    viewModel: NearbyPostsViewModel = hiltViewModel(),
    ...
    BaseScreen(
        ...
        if(hasLocationPermission) {
            ...
            Box(
                ...
                Text(text = stringResource(R.string.locationpermission_needed),color = Color.Gray,modifier = Modifier.align(Alignment.Center))
